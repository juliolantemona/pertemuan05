    ...
    return (
        <>
            <div class="flex justify-center items-center h-screen w-full bg-gradient-to-r from-blue-500 to-purple-600">
                <div class="background-blur-md w-1/2 bg-white bg-opacity-25 rounded-lg shadow-2xl p-8 m-4">
                    <h1 class="block w-full text-center tect-gray-800 text-2xl font-bold mb-6">
                        Registarsi
                    </h1>
                    <form action="/" method="post">
                        <div class="flex flex-col mb-4">
                            ...
                            <div>
                                <input
                                class="border py-2 text-gray-800"
                                type="radio"
                                name="gender"
                                id="pria"
                                />
